        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('pinjams.update', $pinjams->id) }}" method="POST" class="row">
                        @csrf
                        @method('PUT')
                        <div class="col-4">
                            ...
                            <input type="text" class="form-control" id="no_transaksi_pinjam" name="no_transaksi_pinjam"
                                value="{{ old('no_transaksi_pinjam', $pinjams->no_transaksi_pinjam) }}">
                        </div>
                        ...
                        <div class="col-4">
                            ...
                            <select class="form-control" name="kd_anggota" id="kd_anggota">
                                ...
                                @foreach ($anggotas as $val)
                                    <option value="{{ $val->kd_anggota }}" @selected(old('kd_anggota', $pinjams->kd_anggota) == $val->kd_anggota)>
                                        {{ $val->nm_anggota }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-4 mb-2">
                            ...
                            <input type="date" class="form-control" name="tg_pinjam" id="tg_pinjam"
                                value="{{ old('tg_pinjam', $pinjams->tg_pinjam) }}">
                        </div>
                        ...
                        <div class="col-4">
                            ...
                            <input type="date" class="form-control" name="tg_bts_kembali" id="tg_bts_kembali"
                                value="{{ old('tg_bts_kembali', $pinjams->tg_bts_kembali) }}">
                        </div>
                        ...
                        <div class="col-4">
                            ...
                            <select class="form-control" name="kd_koleksi" id="kd_koleksi">
                                ...
                                @foreach ($koleksis as $item)
                                    <option value="{{ $item->kd_koleksi }}" @selected(old('kd_koleksi', $pinjams->kd_koleksi) == $item->kd_koleksi)>
                                        {{ $item->kd_koleksi }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-4 mt-3">
                            ...
                            <input type="text" class="form-control" name="jns_bhn_pustaka" id="jns_bhn_pustaka"
                                value="{{ old('jns_bhn_pustaka', $pinjams->jns_bhn_pustaka) }}">
                        </div>
